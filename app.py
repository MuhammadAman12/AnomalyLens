...
with st.sidebar:
    ...
    st.caption(
        "Configure your dataset and anomaly detection settings."
    )
...
if len(numeric_columns) < 2:
    ...
    st.error(
        "This dataset needs at least two numerical "
...
with st.sidebar:
    ...
    selected_columns = st.multiselect(
        ...
        help=(
            "Choose the numerical features that should "
            "be used by the anomaly detection models."
        )
    )
    ...
    contamination = st.slider(
        ...
        step=0.01,
        help=(
            "Used by Isolation Forest and Local Outlier "
            "Factor to estimate the expected proportion "
            "of anomalous records."
        )
    )
...
with overview_tab:
    ...
    if not run_detection:
        ...
        st.info(
            "Configure the detection settings in the "
...
with visualization_tab:
    ...
    if not run_detection:
        ...
        st.info(
            "Run anomaly detection to view interactive "
...
with comparison_tab:
    ...
    if not run_detection:
        ...
        st.info(
            "Select **Compare All Algorithms** and run "
            "the analysis to compare model results."
        )
...
with suspicious_tab:
    ...
    if not run_detection:
        ...
        st.info(
            "Run a single anomaly detection model to "
...
if run_detection:
    ...
    if detection_mode == "Single Algorithm":
        ...
        with visualization_tab:
            ...
            st.caption(
                "Use the chart controls to zoom, "
                "pan, and inspect individual records."
            )
        ...
        with comparison_tab:
            ...
            st.info(
                ...
                "**Single Algorithm** mode. "
                "Select **Compare All Algorithms** "
                "from the sidebar to view model comparison."
            )


        # ==================================================
        # SUSPICIOUS RECORDS TAB
        # ==================================================
        ...
        with suspicious_tab:
            ...
            if "Anomaly Score" in results.columns:
                ...
                st.caption(
                    "Records are ranked by anomaly score. "
                    "Higher scores indicate more unusual "
                    "observations."
                )
                ...
                st.info(
                    "DBSCAN does not currently provide "
                    "a normalized anomaly score. "
                    "DBSCAN scoring will be added in a "
                    "future update."
                )
            ...
            st.caption(
                f"{len(anomalies):,} anomalous records "
                f"detected using {algorithm}."
            )
    ...
    # ==================================================
        ...
        with overview_tab:
            ...
            st.write(
                f"**{at_least_two_count:,} records** "
                "were flagged by at least two algorithms."
            )

            st.write(
                f"**{all_three_count:,} records** "
                "were flagged by all three algorithms."
            )

            st.caption(
                "Different algorithms may detect different "
                "patterns because they use different "
                "definitions of anomalous behavior."
            )


        # ==================================================
        # VISUALIZATION TAB — COMPARISON MODE
        # ==================================================

        with visualization_tab:

            st.info(
                "Individual anomaly maps are available "
                "in Single Algorithm mode. "
                "Comparison mode focuses on model-level "
                "agreement and detection differences."
            )
        ...
        with comparison_tab:
            ...
            st.caption(
                ...
                "records identified as anomalous by each model."
            )
            ...
            st.caption(
                "A value of 3 means that Isolation Forest, "
                "Local Outlier Factor, and DBSCAN all flagged "
                "the same record."
            )


        # ==================================================
        # SUSPICIOUS TAB — COMPARISON MODE
        # ==================================================
        ...
        with suspicious_tab:
            ...
            st.caption(
                "Records flagged by multiple algorithms "
                "can be useful candidates for investigation."
            )
            ...
            st.download_button(
                ...
                data=consensus_csv,
                file_name=(
                    "anomalylens_model_comparison.csv"
                ),
                mime="text/csv",
                use_container_width=True
            )